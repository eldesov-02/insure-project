...
def front_view(request):
    return render(request,'insurance_front/index1.html')

def frontabout_view(request):
    return render(request,'insurance_front/about.html')

def frontservice_view(request):
    return render(request,'insurance_front/service.html')

def frontfeature_view(request):
    return render(request,'insurance_front/feature.html')

def frontcontact_view(request):
    return render(request,'insurance_front/contact.html')

def front404_view(request):
    return render(request,'insurance_front/404.html')

def frontteam_view(request):
    return render(request,'insurance_front/team.html')

def frontappoint_view(request):
    return render(request,'insurance_front/appointment.html')

def fronttesti_view(request):
    return render(request,'insurance_front/testimonial.html')
