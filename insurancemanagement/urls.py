...
urlpatterns = [
    ...
    path('front', views.front_view),
    path('frontabout', views.frontabout_view),
    path('frontservice', views.frontservice_view),
    path('frontfeature', views.frontfeature_view),
    path('frontcontact', views.frontcontact_view),
    path('front404', views.front404_view),
    path('frontteam', views.frontteam_view),
    path('frontappoint', views.frontappoint_view),
    path('fronttesti', views.fronttesti_view),
